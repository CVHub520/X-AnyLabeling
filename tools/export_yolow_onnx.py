...
def preprocess_image(image_path, input_shape):
    ...
    image = cv2.resize(im0, input_shape)  # Resize to the input dimension expected by the YOLO model
...
def postprocess_results(output_image, scores, class_ids, bbox, input_shape, image_shape, score_threshold):
...
def forward(image_path, onnx_path, score_threshold):
    ...
    output_image = postprocess_results(im0, scores, class_ids, bboxes, input_shape, image_shape, score_threshold)
