...
a = Analysis(
    ...
    datas=[
       ...
       ('/path/to/your/envs/x-anylabeling-gpu/Lib/site-packages/onnxruntime/capi/onnxruntime_providers_cuda.dll', 'onnxruntime/capi'),
       ('/path/to/your/envs/x-anylabeling-gpu/Lib/site-packages/onnxruntime/capi/onnxruntime_providers_shared.dll', 'onnxruntime/capi')
    ],
    hiddenimports=[],
    hookspath=[],
    runtime_hooks=[],
