...
def create_yolo_dataset(image_list: List[str], task_type: str, dataset_ratio: float, data_file: str, output_dir: str = None, pose_cfg_file: str = None) -> str:
    ...
    def _process_images_batch(image_label_pairs, images_dir, labels_dir, converter, mode):
        for image_file, label_file in image_label_pairs:
            ...
            if label_file and os.path.exists(label_file):
                dst_label_path = os.path.join(labels_dir, os.path.splitext(filename)[0] + ".txt")
    ...
    _process_images_batch(all_train_images, train_images_dir, train_labels_dir, converter, mode)
    _process_images_batch(val_valid_images, val_images_dir, val_labels_dir, converter, mode)
