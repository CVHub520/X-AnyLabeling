...
class GeCoONNX:
    ...
    def __init__(self, encoder_model_path, decoder_model_path, input_size, box_threshold) -> None:
    ...
    def get_input_points(self, prompt):
        ...
        points = []
        for mark in prompt:
            points.append([mark["data"][0], mark["data"][1], mark["data"][2], mark["data"][3]])  # top left
    ...
    def run_decoder(
        ...
        pred_bboxes = pred_bboxes / np.array([scale_factor, scale_factor, scale_factor, scale_factor]) * self.input_size
    ...
    def encode(self, cv_image):
        ...
        cv_image = cv2.copyMakeBorder(cv_image, top, bottom, left, right, cv2.BORDER_CONSTANT, value=(0,0,0))  # add border  
...
class GeCo(Model):
    ...
    def __init__(self, config_path, on_message) -> None:
        ...
        # Load models
        self.model = GeCoONNX(
            encoder_model_abs_path, decoder_model_abs_path, self.input_size, self.box_threshold
        )
    ...
    def predict_shapes(self, image, filename=None) -> AutoLabelingResult:
        ...
        try:
            ...
            for det_bbox in bboxes:
                shapes.append(self.post_process(det_bbox))
    ...
    def post_process(self, bbox, label="AUTOLABEL_OBJECT"):
        """
        Post process masks
        """           
